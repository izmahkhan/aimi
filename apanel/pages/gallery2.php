...
if ($_REQUEST['mode'] == 'update' || $_REQUEST['mode'] == 'add') {
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>Add/Update Gallery - Community Visits</h1>
            <?php echo getBredcrum(array('gallery2.htm?1' . $pager => 'Gallery - Community Visits', '#' => 'Add/Update')); ?>
        </section>
                            ...
                            <div class="box-body">
                                <div class="col-sm-8 col-sm-offset-1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        &nbsp; <a href="<?= $apath; ?>gallery2.htm" class=" btn btn-default btn-lg"> <i class="fa fa-arrow-left"></i> Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>Manage Gallery - Community Visits</h1>
            <?php echo getBredcrum(array('#' => 'Gallery - Community Visits')); ?>
        </section>
        <section class="content">
            <div class="row">
                <div class="col-md-12"><?= showMsg(); ?></div>
                        ...
                        <div class="box-header">
                            ...
                            <div class="box-tools row">
                                <div class="col-md-6 pull-right text-right">
                                    ...
                                    <a href="<?= $apath; ?>gallery2.htm?mode=add" id="sample_editable_1_new" class="btn btn-primary" style="margin-right:10px;">Add New <i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="box-body table-responsive">
                            <form name="updateForm" id="updateForm" action="" method="post">
                                <table width="100%" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                            $paging = getPaging('tbl_gallery', "WHERE gal_type='community' ORDER BY gal_order ASC", 20, $_REQUEST['page'], '?', $_GET['pager']);
                                            $pagination = $paging[1];
