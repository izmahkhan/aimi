                        ...
                        <div class="box box-info">
                            <div class="box-body">
                                <div class="col-sm-8 col-sm-offset-1">
                                    ...
                                    <?= formText('Title', 'list_title', $data['list_title']) ?>
                                    <?= formDatepicker('Date', 'list_desc', $data['list_desc']) ?>
                                    <?= formDownloadFileForms('Waiting List File', 'list_image', $data['list_image'], 'media') ?>
                                    ...
                                    <tbody>
                                        ...
                                        if ($rlist_pages = getList($paging[0])) {
                                            while ($row = fetch($rlist_pages)) {
                                                ...
                                                ?>
                                                <tr class="odd gradeX">
                                                    <td><?= stripslashes($row['list_title']); ?></td>
                                                    <td><?= date('F d, Y', strtotime($row['list_desc'])); ?></td>
