...
if (isset($_POST['feedback_form']) && $_POST['feedback_form'] == 'posted') {

    if (empty($_REQUEST['name']) || empty($_REQUEST['email']) || empty($_REQUEST['feedback'])) {
        $errorflag = 1;
...
//        $verifyResponse = file_get_contents('https://www.google.com/recaptcha/api/siteverify?secret=' . $secret . '&response=' . $_POST['g-recaptcha-response']);
	...
	<td width='25%' style='background: #FFFFFF;height: 85px;padding: 5px 0px 0px 20px;' align='left' ><a href='" . $path . "' style='font-size: 24px;text-align: left;color: #fff;text-decoration: none;'><img src='" . $path . "uploads/logo/" . $site_logo . "' height='50' alt='" . $site_name . "' /></a></td>
	...
	<p style='text-align:left;padding:0px 20px;'>You have received the following feedback:</p>
	...
	<td width='15%'><strong>Occupation</strong></td>

	<td width='85%'>" . stripslashes($_POST["occupation"]) . "</td>
	...
	<td width='85%'>" . stripslashes($_POST["phone"]) . "</td>
	...
	<td style='vertical-align:top;'><strong>Feedback</strong></td>

	<td>" . stripslashes($_POST["feedback"]) . "</td>
	...
	<td height='30' bgcolor='#FFFFFF' class='footer' style='padding-left:20px;color:#333;'>" . $site_copyright . "</td>
        ...
        $subject = "Feedback : " . stripslashes($_POST["phone"]);
...
//        @mail($emailto, $subject, $body, $headers);
        ...
        unset($_POST);
        $_SESSION['successMsg'] = "Your feedback has been submitted successfully.";
    }
}
?>