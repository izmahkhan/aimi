...
<div class="inner-page-banner-area" style="background-image: url('<?= $path; ?>uploads/banners/<?= $banners['news_bg']?>');">
  <div class="container">
    <div class="pagination-area">
      <h1><?=  getCategoryName($_REQUEST['category']) ?></h1>
      <ul>
    ...
    <div class="row">
      <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
        <div class="row">
          ...
          <?php
          global $conn;
          $category_slug= getCategoryId($_REQUEST['category']);
          $paging =getPagingforNews('tbl_news', "WHERE news_category='".$category_slug."' AND  news_status='1' ORDER BY news_order ASC", 8, $_REQUEST['page'], '?', $_GET['pager']);
          $pagination = $paging[1];
