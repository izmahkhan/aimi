...
if ($rs = getListingsSingle('waiting_bds', array('list_id' => $list_id))) {
} else {
            ...
            <p class="text-center">
                <div class="row">
                    <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 col-md-push-3">
                        <h2 class="title-default-left">Waiting List BDS - <?= date('M d, Y', strtotime($rs['list_desc'])); ?>
