    ...
    <div class="row">
      <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
        <div class="row">
          <?php
          global $conn;
          $got_search=($_POST['search_inp']);
          $paging =getPagingforNews('tbl_news', "WHERE news_title like '%".$got_search."%' OR news_desc like '%".$got_search."%' OR news_date like '%".$got_search."%' OR news_detail like '%".$got_search."%' ORDER BY news_order ASC", 8, $_REQUEST['page'], '?', $_GET['pager']);
          $pagination = $paging[1];
          ...
          ?>
          <h4 class="title-default-center">Nothing Matched!</h4>
          <?php
        }
        ?>
      </div>
        ...
        <div class="sidebar-box-inner">
          ...
          <ul class="sidebar-categories">
            ...
            while($row=$ex->fetch_array()){
              ...
              ?>
              <li>
                <a <?= ($_REQUEST['category'] == $got_cat) ? 'class="active"' : ''; ?> href="<?= $path ?>category/<?= $row['list_slug']; ?>"><?= $row['list_title']; ?></a>
              </li>
              <?php
